export default {
  ...
  atLeastOneLoginRequired: "At least one of password, SMS, or LDAP login must be enabled",
  enableLdapLogin: "Enable LDAP login",
  ldapUrl: "LDAP server URL",
  ldapUrlPlaceholder: "e.g. ldap://ldap.example.com:389",
  ldapBindDn: "Bind DN",
  ldapBindDnPlaceholder: "Optional, DN used to search users",
  ldapBindPassword: "Bind password",
  ldapBindPasswordPlaceholder: "Optional",
  ldapUserBaseDn: "User Base DN",
  ldapUserBaseDnPlaceholder: "e.g. ou=users,dc=example,dc=com",
  ldapUserFilter: "User filter",
  ldapUserFilterPlaceholder: "(uid={{username}})",
  ldapUserFilterHelper: "Use {{username}} as placeholder for the login username",
  ldapTest: "LDAP connection test",
  ldapTestSuccess: "LDAP connection successful",
  ldapTestFailed: "LDAP connection failed",
  testButton: "Test",
  siteHide: "Site Hide",
