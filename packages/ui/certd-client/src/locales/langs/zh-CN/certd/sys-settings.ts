export default {
  ...
  sendSuccess: "发送成功",
  atLeastOneLoginRequired: "密码、手机号、LDAP 登录至少开启一种",
  enableLdapLogin: "启用 LDAP 登录",
  ldapUrl: "LDAP 服务器地址",
  ldapUrlPlaceholder: "如 ldap://ldap.example.com:389",
  ldapBindDn: "绑定 DN",
  ldapBindDnPlaceholder: "可选，用于搜索用户的 DN",
  ldapBindPassword: "绑定密码",
  ldapBindPasswordPlaceholder: "可选",
  ldapUserBaseDn: "用户 Base DN",
  ldapUserBaseDnPlaceholder: "如 ou=users,dc=example,dc=com",
  ldapUserFilter: "用户过滤条件",
  ldapUserFilterPlaceholder: "(uid={{username}})",
  ldapUserFilterHelper: "使用 {{username}} 作为用户名的占位符",
  ldapTest: "LDAP 连接测试",
  ldapTestSuccess: "LDAP 连接成功",
  ldapTestFailed: "LDAP 连接失败",
  testButton: "测试",
  siteHide: "站点隐藏",
